namespace app.advertise.DataAccess
{
    ...
    internal static partial class Queries
    {
        ...
        internal const string Validate_Appli_By_Id = "SELECT apm.NUM_APPLI_ULBID,apm.NUM_APPLI_ID,apm.VAR_APPLI_APPLINO,apm.DAT_APPLI_APPLIDT,apm.VAR_APPLI_LICENO, apm.VAR_APPLI_LICEOUTNO,apm.VAR_APPLI_APPLINAME,apm.VAR_APPLI_ADDRESS,apm.VAR_APPLI_EMAIL, apm.NUM_APPLI_MOBILENO,apm.DAT_APPLI_FROMDT,apm.DAT_APPLI_UPTODT,apm.NUM_APPLI_QTY, apm.DAT_APPLI_INSDT,apm.VAR_APPLI_APPROVFLAG,apm.DAT_APPLI_APPROVDT,apm.DAT_APPLI_UPDT,apm.VAR_APPLI_APPROVBY,apm.VAR_APPLI_APPROVREMARK, apm.NUM_APPLI_HORDINGID,apm.NUM_APPLI_PRABHAGID,apm.NUM_APPLI_LOCATIONID, ahm.VAR_HORDING_HOLDNAME,ahm.VAR_HORDING_HOLDADDRESS,ahm.NUM_HORDING_LENGTH,ahm.NUM_HORDING_WIDTH,ahm.NUM_HORDING_TOTALSQFT,ahm.VAR_HORDING_OWNERSHIP, adm.VAR_DISPLAYTYPE_NAME,adm.num_displaytype_id,ahtm.VAR_HOARDINGTYPE_NAME, aprm.VAR_PRABHAG_NAME,alm.VAR_LOCATION_NAME,adacm.NUM_CORPORATION_ID,adacm.VAR_CORPORATION_NAME,adacm.BLOB_CORPORATION_IMG FROM aoad_appli_mst apm  LEFT JOIN aoad_prabhag_mas aprm ON aprm.NUM_PRABHAG_ID=apm.NUM_APPLI_PRABHAGID LEFT JOIN aoad_location_mst alm ON alm.NUM_LOCATION_ID=apm.NUM_APPLI_LOCATIONID  LEFT JOIN aoad_hording_mst ahm ON ahm.NUM_HORDING_ID = apm.NUM_APPLI_HORDINGID   LEFT JOIN aoad_displaytype_mst adm ON adm.num_displaytype_id=ahm.NUM_HORDING_DISPTYPEID  LEFT JOIN aoad_hoardingtype_mst ahtm ON ahtm.NUM_HOARDINGTYPE_ID=ahm.VAR_HORDING_HOLDTYPE  LEFT JOIN admins.aoma_corporation_mas adacm ON adacm.NUM_CORPORATION_ID=apm.NUM_APPLI_ULBID WHERE apm.NUM_APPLI_ID=:p_appli_id";
        internal const string Validate_Appli_By_Id_Number = "SELECT apm.NUM_APPLI_ULBID,apm.NUM_APPLI_ID,apm.VAR_APPLI_APPLINO,apm.DAT_APPLI_APPLIDT,apm.VAR_APPLI_LICENO, apm.VAR_APPLI_LICEOUTNO,apm.VAR_APPLI_APPLINAME,apm.VAR_APPLI_ADDRESS,apm.VAR_APPLI_EMAIL, apm.NUM_APPLI_MOBILENO,apm.DAT_APPLI_FROMDT,apm.DAT_APPLI_UPTODT,apm.NUM_APPLI_QTY, apm.DAT_APPLI_INSDT,apm.VAR_APPLI_APPROVFLAG,apm.DAT_APPLI_APPROVDT,apm.DAT_APPLI_UPDT,apm.VAR_APPLI_APPROVBY,apm.VAR_APPLI_APPROVREMARK, apm.NUM_APPLI_HORDINGID,apm.NUM_APPLI_PRABHAGID,apm.NUM_APPLI_LOCATIONID, ahm.VAR_HORDING_HOLDNAME,ahm.VAR_HORDING_HOLDADDRESS,ahm.NUM_HORDING_LENGTH,ahm.NUM_HORDING_WIDTH,ahm.NUM_HORDING_TOTALSQFT,ahm.VAR_HORDING_OWNERSHIP, adm.VAR_DISPLAYTYPE_NAME,adm.num_displaytype_id,ahtm.VAR_HOARDINGTYPE_NAME, aprm.VAR_PRABHAG_NAME,alm.VAR_LOCATION_NAME, adacm.NUM_CORPORATION_ID,adacm.VAR_CORPORATION_NAME,adacm.BLOB_CORPORATION_IMG FROM aoad_appli_mst apm  LEFT JOIN aoad_prabhag_mas aprm ON aprm.NUM_PRABHAG_ID=apm.NUM_APPLI_PRABHAGID LEFT JOIN aoad_location_mst alm ON alm.NUM_LOCATION_ID=apm.NUM_APPLI_LOCATIONID  LEFT JOIN aoad_hording_mst ahm ON ahm.NUM_HORDING_ID = apm.NUM_APPLI_HORDINGID   LEFT JOIN aoad_displaytype_mst adm ON adm.num_displaytype_id=ahm.NUM_HORDING_DISPTYPEID  LEFT JOIN aoad_hoardingtype_mst ahtm ON ahtm.NUM_HOARDINGTYPE_ID=ahm.VAR_HORDING_HOLDTYPE LEFT JOIN admins.aoma_corporation_mas adacm ON adacm.NUM_CORPORATION_ID=apm.NUM_APPLI_ULBID  WHERE apm.NUM_APPLI_ID=:p_appli_id AND apm.VAR_APPLI_APPLINO=:p_app_no";
